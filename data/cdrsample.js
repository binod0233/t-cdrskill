        ...
        sample: {
          ...
          data: (
            <div>
              ...
              and Project Control Engineer for the IFC (Issued for Construction)
              package stage of the company &apos;Damavand Combined Cycle Power
              Plant”.“Planning and Project Control at Damavand Combined Cycle
              Power Plant&apos; was the title of the project.
              <br />
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              ProjectOver the Second career episode Report, the author outlines
              the Engineering skills he utilized in a year-long project as an
              industrial
              <br />
              The author&apos;s responsibilities Includes:
            </div>
...
`,
  ...
  chemicalEngineer: {
    ...
    titleDescription: `Get your CDR report assisted by the finest CDR report writing service provider in Australia. Our team with suitable skills and qualification prepare your CDR report. We focus on providing topnotch CDR report in time. Writers focus on displaying your skills and qualifications as per the guidance provide by Engineers Australia in Migration Skill Assessment (MSA) booklet. 
      ...
      `,
    titleImage: "/images/SpecificSamples/chemicalEngineering.png",
    list: [
      {
        image: "/images/SpecificSamples/sample1.png",
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              <br />
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in. The project name was “Production of
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Schlumberger. During this time, his duties and responsibilities in
              the project “Soil Stability” were:
            </div>
          ),
          list: [
            `
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              “Drive Pile Foundation Design and Soil Analysis”. During the time,
              the responsibilities of the author were to:
            </div>
          ),
          list: [
    ...
    sampleList: [
      {
        sample: {
          ...
          data: (
            <div>
              <strong>Project Name:</strong>Al Raha Beach Resort project <br />
              In the first Career Episode, the author explains his contributions
              to Ghantoot Group – Alumena Aluminum Divisions as a Structural
              Engineer. Here, he describes the implementation of alteration of
              design and construction methods in the project named “Al Raha
              Beach Resort project”, highlighting his responsibilities, which
              were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              <br />
              In the second career episode, the author explains the engineering
              skills he used when working as a Principal Engineer in Auckland.
              During this time, his duties and responsibilities in the project
              “Design of The Foundation and The Superstructure for A Residential
              Building” were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              <br />
              In the third Career Episode, the author demonstrates the technical
              skills he used during his work tenure at a company. The Project
              was “Construction of (2*270) MW Thermal Power Station”. The key
              responsibility of the writer was to:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              <br />
              In the first career episode, the author explains the engineering
              skills he used when completing his Bachelor of Technology in Civil
              engineering. During this time, his duties and responsibilities in
              the project “Construction of Temporary Steel Bridge” were:
            </div>
          ),
          list: [
            `
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              carried out to fulfil his degree in civil engineering. The project
              was titled “Experimental Analysis of Glass Fiber in Concrete”, and
              his roles were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Related Protocol.
              <br />
              In the first Career Episode, the author elaborates on the project
              titled as “Integration of 3G Technology with Related Protocol”
              which involved studying Master of Information Technology in
              Network management. Involved responsibilities were:
            </div>
          ),
          list: [
            `
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              <br />
              In the second Career Episode, the author explains the engineering
              skills used in the project carried out for the fulfilment of a
              Master’s Degree (Telecommunications Field Engineers). Duties and
              responsibilities in the project “Reliable Control of Ship-mounted
              Satellite Tracking Antenna” were:
            </div>
          ),
          list: [
    ...
    sampleList: [
      {
        sample: {
          ...
          data: (
            <div>
              <strong>Project Name:</strong>Experimental Analysis of Glass Fiber
              in Concrete.
              <br />
              In the first Career Episode, the author explains the project he
              carried out and the fulfilment of his degree in civil engineering.
              The project was titled “Experimental Analysis of Glass Fiber in
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              <br />
              In the second Career Episode, the author explains the engineering
              skills he used in the project he was involved in for a duration of
              a year as a civil engineer technician. His responsibilities and
              duties in this project “Low-Energy and Passive Buildings Economics
              of New Technologies” were:{" "}
            </div>
          ),
          list: [
      ...
      },
      {
        sample: {
          ...
          data: (
            <div>
              <strong>Project Name:</strong>
              Construction of a Solid 3D Model of Geology in Sardinia Using GIS
              Methods.
              <br />
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              project he worked during the accomplishment of Bachelor’s degree.
              The project name was “Study of Electrochemical Reduction of
              Titanium Dioxide (TiO2) for the extraction of Titanium”. During
              the project the author’s responsibilities were:
            </div>
          ),
          list: [
            `
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Nanoparticles and its magnetic properties”. During the project the
              authors responsibility were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in. The project name was “Fabrication and
              Analysis of Aluminum Alloy 2219” During the project the authors
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the first career episode Report, the author explains a
              project he worked during the accomplishment of Bachelor’s degree.
              The project name was “Road and Drainage Design Project”. During
              the project the author’s responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in. The project name was “Reconstruction
              of the Station Node” During the project the authors
              responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the first career episode Report, the author explains a
              project he worked during the accomplishment of Bachelor’s degree.
              The project name was “MATLAB Simulation of Solar Photo Voltaic
              Module and Hydropower Plant”. During the project the author’s
              responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in. The project name was “High Sped
              Multiphoton Imaging” During the project the authors
              responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the first career episode Report, the author explains a
              project he worked during the accomplishment of Bachelor’s degree.
              The project name was “Advanced Mining Seismicity Processing”.
...
`,
      ...
      },
      {
        sample: {
          ...
          data: (
            <div>
              <strong>Project Name: </strong>“Copper Extraction and Processing”
              <br />
              Over the Second career episode Report, the author outlines the
              management skills he utilized in a year-long project as an
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in. The project name was “Hard Rock Mine
              Design and Feasibility” During the project the authors
              responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the first career episode Report, the author explains a
              project he worked during the accomplishment of Bachelor’s degree.
              The project name was “Advanced Petroleum Seismicity Processing”.
              During the project the author’s responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Second career episode Report, the author outlines the
              management skills he utilized in a year-long project as an
              engineering manager. The project name was “Designing, development,
              and analysis of a dynamic model of crude oil distillation column
              in HYSYS: Operator Training Simulator”. During the project the
              authors responsibility were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in. The project name was “Designing A Palm
              Oil Effluent Based Power Plant”. During the project the authors
              responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the first career episode Report, the author explains a
              project he worked during the accomplishment of Bachelor’s degree.
              The project name was “Design of Custom Engine Mount”. During the
              project the author’s responsibilities were:
            </div>
          ),
          list: [
            `
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in. The project name was “Designing a
              Quadcopter”. During the project the authors responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the first career episode Report, the author explains a
              project he worked during the accomplishment of Bachelor’s degree.
              The project name was “Evaluate different rice milling machines”.
              During the project the author’s responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in. The project name was “Preparing
              Strategies of Farm Mechanization Project”. During the project the
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the first career episode Report, the author explains a
              project he worked during the accomplishment of Bachelor’s degree.
              The project name was “Non-Invasive Blood Pressure Measurement
              System”. During the project the author’s responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Second career episode Report, the author outlines the
              management skills he utilized in a year-long project as an
              engineering manager. The project name was “Voice Controlled modern
              and modified Wheel Chair”. During the project the authors
              responsibility were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in.The project name was “Handling with the
              biomedical signals”. During the project the authors
              responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the first career episode Report, the author explains a
              project he worked during the accomplishment of Bachelor’s degree.
              The project name was “Wireless Network Security Improvement”.
              During the project the author’s responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in. The project name was “Robotic
              Exploration of Extreme Environments (ROBEX)”. During the project
              the authors responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the first career episode Report, the author explains a
              project he worked during the accomplishment of Bachelor’s degree.
              The project name was “Finding perfect Solutions for Environmental
              Changes”. During the project the author’s responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Wastewater System”. During the project the authors responsibility
              were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in. The project name was “Green World and
              Road Management”. During the project the authors responsibilities
              were:
            </div>
          ),
          list: [
      ...
      },
      {
        sample: {
          ...
          data: (
            <div>
              <strong>Project Name:</strong>
              “Characterization of casting defects in DC cast magnesium alloys”
              <br />
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in. The project name was “Characterization
              of casting defects in DC cast magnesium alloys”. During the
...
`,
  ...
  electricalengineeringDraftsperson: {
    ...
    titleDescription: `Get your CDR report assisted by the finest CDR report writing service provider in Australia. Our team with suitable skills and qualification prepare your CDR report. We focus on providing topnotch CDR report in time. Writers focus on displaying your skills and qualifications as per the guidance provide by Engineers Australia in Migration Skill Assessment (MSA) booklet. 
      CDRskillassessment team provide a reliable CDR report writing service for the engineers who are looking for better employment opportunity migrating to Australia. Take a look at the sample and get ideas on what are to be include in your CDR report.
       `,
    titleImage: "/images/SpecificSamples/electricalengineeringDraftsperson.png",
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the first career episode Report, the author explains a
              project he worked during the accomplishment of Bachelor’s degree.
              The project name was “Design of Access Control System”. During the
              project the author’s responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in. The project name was “Power Supply
              Using Reversible Pem Fuel Cell for the Domestic usage”. During the
              project the authors responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the first career episode Report, the author explains a
              project he worked during the accomplishment of Bachelor’s degree.
              The project name was “Evaluation of Microwave Microscopy for
              Dielectric Characterization”. During the project the author’s
              responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Over the Third career episode Report, the author outlines his
              technical abilities, which he had used to accomplish the 36-month
              project he was involved in. The project name was “Optimal
              Allocation of Static and Dynamic Reactive Power Support for
              Enhancing Power System Security”. During the project the authors
              responsibilities were:
            </div>
          ),
          list: [
    ...
    sampleList: [
      {
        sample: {
          ...
          data: (
            <div>
              <strong>Project Name:</strong> “Design of The Latent Heat Thermal
              Storage (LHTS) Unit”
              <br />
              ...
              storage (LHTS) unit. During the time, the responsibilities of the
              author were to:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              <br />
              In the second Career Episode, the author explains the engineering
              skills he used in the project he carried out in the Commonwealth
              Scientific and Industrial Research Organization (CSIRO) for the
              degree in Masters of Engineering Science (Advanced Manufacturing
              Technology). His duties and responsibilities in the project
              “Determination of a relative equation to find wettability of the
              material through water contact angle” were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              <br />
              In the third Career Episode, the author describes the project
              titled “CP system based upon Optimizing of Anodes order quantity”.
              He did this project while working at L&T Hydrocarbons. Some of his
              roles and responsibilities in this project were:
            </div>
          ),
          list: [
    ...
    sampleList: [
      {
        sample: {
          ...
          data: (
            <div>
              <strong>Project Name:</strong> “Design and automation of fire tube
              boiler”
              <br />
              In the first career episode, the author describes the project he
...
`,
      ...
      },
      {
        sample: {
          ...
          data: (
            <div>
              <strong>Project Name: </strong>Use of a telescope in Modification
              of a Tractor.
              <br />
              In the second career episode, the author describes the project he
              did as a part of his undergraduate studies. The name of the
              project was: “Use of a telescope in Modification of a Tractor” and
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              project name was “Process design of the Cystoscopy Ureteral Stent
              Removal device”. Key responsibilities in this project were:
            </div>
          ),
          list: [
    ...
    sampleList: [
      {
        sample: {
          ...
          data: (
            <div>
              <strong>Project Name:</strong> Improvement of the assembly working
              station.
              <br />
              In the first career episode, the author describes the project he
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              performed during his Bachelor’s studies. The major tasks performed
              by the author in this project are as follows:{" "}
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              skills he used when he was working as Junior Industrial Engineer.
              During this time his duties and responsibilities in the project
              “Installation of New Production Line” were:
            </div>
          ),
          list: [
...
`,
  ...
  telecommunicationsNetworkEngineer: {
    ...
    titleDescription: `Get your CDR report assisted by Australia's finest CDR report writing service provider. Our team with relevant skills and qualifications will prepare your CDR report. We focus on providing top-notch CDR reports in time. Writers focus on displaying your skills and qualifications as per the guidance provided by the Engineers Australia in Migration Skill Assessment (MSA) booklet. 
      CDRskillassessment’s team provides a reliable CDR report writing service for engineers seeking better employment opportunities migrating to Australia. Take a look at the sample and get ideas on what is included in your CDR report.
       `,
    titleImage: "/images/SpecificSamples/telecommunicationsNetworkEngineer.png",
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              “Tracking Robot Using Indoor Wireless Sensor Networks”. During the
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              <br />
              In the second Career Episode, the author explains the engineering
              skills he used in this thesis for the Master of ICT. His
              responsibilities in the project “Telecommunication Services
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              <br />
              In the third career episode, the writer talks about the details of
              the project that he had accomplished during his under-graduation.
              The title of the project was: “Long Term Evolution Technology” and
              his responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Bachelor’s Degree requirements. The “Peer-to-peer Data Integration
              Based on Schema” responsibilities of the author were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              <br />
              In the second Career Episode, the author explains the engineering
              skills in the project he was involved in for three months as an
              intern. His duties and responsibilities in the project “Simulation
              versus Coding” were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              <br />
              In the first career episode, the author describes the project he
              did when he was pursuing his Bachelor of Technology in Electronics
              and Telecommunications. This career episode is based on his
              graduation project named; a home automation system with control
              communication over the GSM network. During the time, the
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              Simulation
              <br />
              In the second Career Episode, the author elaborates on the project
              titled “Local Area Network: Design and Simulation” in which she
              was involved and her responsibilities were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              In the first Career Episode, the author elaborates on the project
              titled as “Integration of 3G Technology with Related Protocol”
              which she was involved in while studying Masters of Information
              Technology in Network management. Her responsibilities were:
            </div>
          ),
          list: [
            `To discover about the 3G technology and protocol related to it and understand the process of 3G working through a survey in the numerous article and other sources available on the internet.
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              railway bridge”. Duties and responsibilities in the project were:
            </div>
          ),
          list: [
        ...
        sample: {
          ...
          data: (
            <div>
              ...
              <br />
              In the third Career Episode, the author demonstrates the drafting
              skills used when involved in the project titled as “Preparing
              plan, section and details drawings of concrete frame structures of
              a residential building”. Following responsibilities were performed
              during the project:
            </div>
          ),
          list: [
