...
const Whatdoes = () => {
  return (
    <div style={{ background: "#E5E5E5" }}>
      <Container>
        <Headings title="What Does CDR Writing Service Include?" />
        <Paragraphs
          data="CDRskillassessment meticulously produces an innovative CDR report that displays your academic and career track record in the 
...
of those elements. Some of our services are as follows:"
        ...
        <Row>
          <Col xs={12} md={6} className="px-md-5 pt-md-5">
            ...
            <p className="stepsParagraph">
              ...
              additional thought and effort. There are three career episodes in
              CDR, and each episode is based on three separate projects that you
              completed in your last year of engineering, internship program,
              and working projects. Our experienced team can support you in
              preparing Career Episode Writing based on your professional
              experiences by enabling you to write all three career episodes
              distinctively.
            </p>
          </Col>
        ...
        <Row>
          ...
          <Col xs={12} md={6}  className="px-md-5 pt-md-5">
            ...
            <p className="stepsParagraph">
              A Summary Statement may be one page long, but it does not diminish
              its significance. It is centred on the significant focal section
              of your three career experiences. The summary statement's contents
              are the competency aspects claimed by you, demonstrating how and
              where you have achieved/applied the claims in your professional
              episodes. Our writers are skilled at aiding you in creating the
              ideal summary statement for your professional experience.
            </p>
          </Col>
        </Row>
        <Row>
          ...
          <Col xs={6} className="px-md-5 pt-md-5">
            ...
            <p className="stepsParagraph ">
              ...
              skills. Our skilled staff can assist you with CPD Writing to offer
              a continuous assessment of your professional learning and
              development.
            </p>
          </Col>
          <Col xs={6}>
        ...
        <Row>
          ...
          <Col xs={6} className="px-md-5 pt-md-5">
            ...
            <p className="stepsParagraph">
              ...
              impression on Engineers Australia (EA). Our professional staff can
              help you write an engaging personal statement for your CV.
            </p>
          </Col>
        </Row>
        </div>
