    ...
    <div className='mt-4 mt-md-0'>
      <div>
        {anzsco === "anzsco-133211-engineering-manager" && (
          <Meta
            title="Engineering Manager | Unit Group 1332 | ANZSCO 133211"
            description="Occupational Unit Group 1332 Engineering Manager. ANZSCO 133211PR Visa for Engineering Managers."
          />
        )}
        {anzsco === "anzsco-233111-chemical-engineer" && (
          <Meta
            title="Chemical Engineer | Unit Group 2331 | ANZSCO 233111"
            description="Occupational Unit Group 2331 Chemical and Materials Engineer. ANZSCO 233111 PR Visa for Chemical Engineer."
          />
        )}
        {anzsco === "anzsco-233211-civil-engineer" && (
          <Meta
            title="Civil Engineer ANZSCO 233211"
            description="Occupational Unit Group 2332 Civil Engineering Professionals. ANZSCO 233211 PR Visa for Civil Engineer."
          />
        )}
        {anzsco === "anzsco-233212-geo-technical-engineer" && (
          <Meta
            title="Geo technical Engineer ANZSCO 233212"
            description="Occupational Unit Group 2332 Civil Engineering Professionals. ANZSCO 233212 PR Visa for Geo-Technical Engineer."
          />
        )}
        {anzsco === "anzsco-233214-structural-engineer" && (
          <Meta
            title="Structural Engineer ANZSCO 233214"
            description="Occupational Unit Group 2332 Civil Engineering Professionals. ANZSCO 233214 PR Visa for Structural Engineer."
          />
        )}
        {anzsco === "anzsco-233215-transport-engineer" && (
          <Meta
            title="Transport Engineer ANZSCO 233215"
            description="Occupational Unit Group 2332 Civil Engineering Professionals. ANZSCO 233215 PR Visa for Transport Engineer."
          />
        )}
        {anzsco === "anzsco-233311-electrical-engineer" && (
          <Meta
            title="Electrical Engineer ANZSCO 233311"
            description="Occupational Unit Group 2333 Electrical Engineers. 
        ...
        {anzsco === "anzsco-233411-electronics-engineer" && (
          <Meta
            title="Electronics Engineer ANZSCO 233411"
            description="Occupational Unit Group 2334 Electronics Engineer. 
        ...
        {anzsco === "anzsco-233511-industrial-engineer" && (
          <Meta
            title="Industrial Engineer ANZSCO 233511"
            description="Occupational Unit Group 2335 Industrial,  Mechanical and  Production  Engineers  ANZSCO 233511 PR Visa for Industrial Engineer"
          />
        )}
        {anzsco === "anzsco-233512-mechanical-engineer" && (
          <Meta
            title="Mechanical Engineer ANZSCO 233512"
            description="Occupational Unit Group 2335 Industrial,  Mechanical and  Production  Engineers  ANZSCO 233512 PR Visa for Mechanical Engineers.
        ...
        {anzsco === "anzsco-233513-production-or-plant-engineer" && (
          <Meta
            title="Production or plant Engineer ANZSCO 233513"
            description="Occupational Unit Group 2335 Industrial,  Mechanical and  Production  Engineers  ANZSCO 233513 PR Visa for Production or Plant engineers
            "
          />
        )}
        {anzsco === "anzsco-233611-mining-engineer" && (
          <Meta
            title="Mining Engineer ANZSCO 233611"
            description="Occupational Unit Group 2336 Mining Engineers ANZSCO 233611 PR Visa for Mining Engineers.
        ...
        {anzsco === "anzsco-233612-petroleum-engineer" && (
          <Meta
            title="Petroleum Engineer ANZSCO 233612"
            description="Occupational Unit Group 2336 Mining Engineers                             ANZSCO 233612 PR Visa for Petroleum Engineers.
        ...
        {anzsco === "anzsco-233911-aeronautical-engineer" && (
          <Meta
            title="Aeronautical Engineer ANZSCO 233911"
            description="Occupational Unit Group 2339 Other Engineering Professionals ANZSCO 233911 PR Visa for Aeronautical Engineer"
          />
        )}
        {anzsco === "anzsco-233912-agricultural-engineer" && (
          <Meta
            title="Agricultural Engineer ANZSCO 233912"
            description="Occupational Unit Group 2339 Other Engineering Professionals ANZSCO 233912 PR Visa for Agriculture Engineer"
          />
        )}
        {anzsco === "anzsco-233913-biomedical-engineer" && (
          <Meta
            title="Biomedical Engineer ANZSCO 233913"
            description="Occupational Unit Group 2339 Other Engineering Professionals ANZSCO 233913 PR Visa for Biomedical Engineer"
          />
        )}
        {anzsco === "anzsco-233914-engineering-technologist" && (
          <Meta
            title="Engineering technologist ANZSCO 233914"
            description="Occupational Unit Group 2339 Other Engineering Professionals ANZSCO 233914 PR Visa for Engineering Technologists"
          />
        )}
        {anzsco === "anzsco-233915-environmental-engineer" && (
          <Meta
            title="Environmental Engineer ANZSCO 233915"
            description="Occupational Unit Group 2339 Other Engineering Professionals ANZSCO 233915 PR Visa for Environmental Engineer."
          />
        )}
        {anzsco === "anzsco-233999-engineering-professionals-nec" && (
          <Meta
            title="Engineering professionals nec ANZSCO 233999"
            description="Occupational Unit Group 2339 Other Engineering Professionals ANZSCO 233999 PR Visa for Engineering Professionals."
          />
        )}
        {anzsco === "computer-networks-and-system-engineers-anzsco-263111" && (
          <Meta
            title="Computer Network and Systems Engineers ANZSCO 263111"
            description="Occupational Unit Group 2631 Other Computer Network Professionals ANZSCO 263111 PR Visa for Computer Network and Systems Engineer."
          />
        )}{" "}
        {anzsco === "telecommunication-engineers-anzsco-263311" && (
          <Meta
            title="Telecommunications Engineer ANZSCO 263311"
            description="Occupational Unit Group 2633 Telecommunications Engineering Professionals ANZSCO 263311 PR Visa for Telecommunications Engineer."
          />
        )}{" "}
        {anzsco === "telecommunication-network-engineers-anzsco-263312" && (
          <Meta
            title="Telecommunications Network Engineers ANZSCO 263312"
            description="Occupational Unit Group 2633 Telecommunications Engineering Professionals ANZSCO 263311 PR Visa for Telecommunications Network Engineer."
          />
        )}{" "}
        {anzsco === "civil-engineering-draftsperson-anzsco-312211" && (
          <Meta
            title="Civil Engineering Draftsperson ANZSCO 312211"
            description="Occupational Unit Group 3122 Civil Engineering Draftsperson and Technician ANZSCO 312211PR Visa for Civil Engineering Draftsperson."
          />
        )}{" "}
        {anzsco === "civil-engineering-technician-anzsco-312212" && (
          <Meta
            title="Civil Engineering Technician ANZSCO 312212"
            description="Occupational Unit Group 3122 Civil Engineering Draftsperson and Technician ANZSCO 312212PR Visa for Civil Engineering Technician ."
          />
        )}{" "}
        {anzsco === "electrical-engineering-draftsperson-anzsco-312311" && (
          <Meta
            title="Electrical Engineering Draftsperson ANZSCO 312311"
            description="Occupational Unit Group 3123 Electrical Engineering Draftsperson and Technician ANZSCO 312311PR Visa for Electrical Engineering Draftsperson."
          />
        )}{" "}
        {anzsco === "electrical-engineering-technician-anzsco-312312" && (
          <Meta
            title="Electrical Engineering Technician ANZSCO 312312"
            description="Occupational Unit Group 3123 Electrical Engineering Draftsperson and Technician ANZSCO 312312PR Visa for Electrical Engineering Technician."
          />
        )}
        {anzsco === "telecommunication-field-engineer-anzsco-313212" && (
          <Meta
            title="Telecommunications Field Engineer ANZSCO 313212"
            description="Occupational Unit Group 3132 Telecommunications Technical 
      ...
      {anzsco === "anzsco-133211-engineering-manager" && (
        <>
          ...
          <Container>
            ...
            {allData.engineeringManager.occupationList.map((l) => (
              <Row>
      ...
      {anzsco === "anzsco-233111-chemical-engineer" && (
        <>
          ...
          <Container>
            ...
            {allData.chemicalEngineer.occupationList.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-233211-civil-engineer" && (
        <>
          ...
          <Container>
            ...
            {allData.civilEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-233112-materials-engineer" && (
        <>
          ...
          <Container>
            ...
            {allData.materialsEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-233212-geo-technical-engineer" && (
        <>
          ...
          <Container>
            ...
            {allData.geotechnicalEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-233214-structural-engineer" && (
        <>
          ...
          <Container>
            ...
            {allData.structuralEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
<Headings
            ...
            />
            {allData.transportEngineer.thirdDescription.map(t=>
             <Paragraphs
             data={t}
           />)
            }
            ...
            {allData.transportEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
       ...
       {anzsco === "anzsco-233311-electrical-engineer" && (
        <>
          ...
          <Container>
            ...
            {allData.electricalEngineer?.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-233411-electronics-engineer" && (
        <>
          ...
          <Container>
            ...
            {allData.electronicsEngineer?.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
<Headings
            ...
            />
            {allData.industrialEngineer.thirdDescription.map(t=>
             <Paragraphs
             data={t}
           />)
            }
            ...
            {allData.industrialEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
<Headings
            ...
            />
            {allData.mechanicalEngineer.thirdDescription.map(t=>
             <Paragraphs
             data={t}
           />)
            }
            ...
            {allData.mechanicalEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
<Headings
            ...
            />
            {allData.plantEngineer.thirdDescription.map(t=>
             <Paragraphs
             data={t}
           />)
            }
            ...
            {allData.plantEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
<Headings
            ...
            />
            {allData.miningEngineer.thirdDescription.map(t=>
             <Paragraphs
             data={t}
           />)
            }
            ...
            {allData.miningEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
<Headings
            ...
            />
            {allData.petroleumEngineer.thirdDescription.map(t=>
             <Paragraphs
             data={t}
           />)
            }
            ...
            {allData.petroleumEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
<Headings
            ...
            />
            {allData.aeronauticalEngineer.thirdDescription.map(t=>
             <Paragraphs
             data={t}
           />)
            }
            ...
            {allData.aeronauticalEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
<Headings
            ...
            />
            {allData.agriculturalEngineer.thirdDescription.map(t=>
             <Paragraphs
             data={t}
           />)
            }
            ...
            {allData.agriculturalEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
<Headings
            ...
            />
            {allData.biomedicalEngineer.thirdDescription.map(t=>
             <Paragraphs
             data={t}
           />)
            }
            ...
            {allData.biomedicalEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
{anzsco === "anzsco-233914-engineering-technologist" && (
        <>
          ...
          <Container>
            ...
            {allData.environmentalEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-233999-engineering-professionals-nec" && (
        <>
          ...
          <Container>
            ...
            {allData.engineeringProfessionals.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-263111-computer-networks-and-system-engineers" && (
        <>
          ...
          <Container>
            ...
            {allData.computerEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
{anzsco === "anzsco-263311-telecommunication-engineers" && (
        <>
          ...
          <Container>
            ...
            {allData.telecommunicationsEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-313212-telecommunication-network-engineers" && (
        <>
          ...
          <Container>
            ...
            {allData.telecommunicationsnetworkEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
{anzsco === "anzsco-312211-civil-engineering-draftsperson" && (
        <>
          ...
          <Container>
            ...
            {allData.civilengineeringDraftsperson.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-312212-civil-engineering-technician" && (
        <>
          ...
          <Container>
            ...
            {allData.civilengineeringTechnician.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-312311-electrical-engineering-draftsperson" && (
        <>
          ...
          <Container>
            ...
            {allData.electricalengineeringDraftsperson.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-312312-electrical-engineering-technician" && (
        <>
          ...
          <Container>
            ...
            {allData.electricalengineeringTechnician.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-313212-telecommunication-field-engineer" && (
        <>
          ...
          <Container>
            ...
            {allData.telecommunicationfieldEngineer.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
{anzsco === "anzsco-312411-electronics-draftsperson" && (
        <>
          ...
          <Container>
            ...
            {allData.electronicsDraftsperson.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-233916-naval-architect" && (
        <>
          ...
          <Container>
            ...
            {allData.navalArchitect.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-313213-telecommunications-network-planner" && (
        <>
          ...
          <Container>
            ...
            />
            {allData.telecommunicationsNetworkPlanner.thirdDescription?.map(t=>(
  <Paragraphs
  data={t}
/>
            ))}
            ...
            {allData.telecommunicationsNetworkPlanner.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
...
{anzsco === "anzsco-313212-telecommunication-technologist" && (
        <>
          ...
          <Container>
            ...
            />
            {allData.telecommunicationsTechnologist.thirdDescription?.map(t=>(
  <Paragraphs
  data={t}
/>
            ))}
            ...
            {allData.telecommunicationsTechnologist.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
      ...
      {anzsco === "anzsco-312999-engineering-technician" && (
        <>
          ...
          <Container>
            ...
            />
            {allData.engineeringTechnicians.thirdDescription?.map(t=>(
  <Paragraphs
  data={t}
/>
            ))}
            ...
            {allData.engineeringTechnicians.occupationList?.map((l) => (
              <Row>
                <Col xs={1} className="pt-1">
                  <img
                    style={{ height: "20px", width: "20px", float: "right" }}
