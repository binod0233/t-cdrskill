...
const Part1 = () => {
  return (
    <div>
      <Container>
        <Headings title="Summary Statement is a key part of CDR Skill Assessments Australia"  />
...
in writing CDR Skill Assessments Australia is to demonstrate how you applied your technical skills and professional and personal attributes. 
