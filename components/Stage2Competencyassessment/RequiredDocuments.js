...
const RequiredDocuments = () => {
  return (
    <Container>
      <Headings
        title="Required documents for Chartered membership of Engineers Australia 
through Stage 2 Competency Assessment"
      />
      <Paragraphs
        data="After selecting one of the digital charactered pathways, engineers willing and possessing every requirement should submit a few 
documents. The submitted documents provide Engineers Australia (EA) with proper and required information about the applicant. 
EA requires the following documents for recognition as chartered membership of Engineers Australia.  "
      />
      ...
      <Row className="desktopScreenSteps">
        ...
        <Col xs={6} className="px-md-5 pt-md-5">
          ...
          <p className="stepsParagraph">
            ...
            job duties and employment. Preparing the above-mentioned submission
            items is a time-consuming and difficult task. If you have a strong
            understanding of the requirements, it can be simple to prepare all
            submissions
          </p>
        </Col>
      </Row>
      <Row className="desktopScreenSteps">
        <Col xs={6} className="px-md-5 pt-md-5">
          ...
          <p className="stepsParagraph ">
            CPD is an abbreviation for Continuing Professional Development, and
            it refers to the learning activities that professionals engage in in
            order to improve and grow their skills. CPD refers to a
            professional&apos;s long-term commitment to improving their skills and
            proficiency.
          </p>
        </Col>
        <Col xs={6}>
      ...
      <Row className="desktopScreenSteps">
        ...
        <Col xs={6} className="px-md-5 pt-md-5 ">
          ...
          <p className="stepsParagraph">
            ...
            Australia. Include both your most recent work experience and the one
            you are currently working on. It should be simple and well-written.
          </p>
        </Col>
      </Row>
