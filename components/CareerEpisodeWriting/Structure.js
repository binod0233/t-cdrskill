...
const Structure = ({ data }) => {
  const { structure, structure_content } = data;
  return (
    <div style={{ background: "#E5E5E5" }}>
      <Container className="pt-5">
        <Headings title={structure} />
        <div className="desktopScreenSteps">
          {structure_content &&
            structure_content.map((item, index) => {
              return (
                <>
                  {index % 2 === 0 ? (
                    <Row key={item.id}>
            ...
            <Col xs={12} className="mt-md-5">
              ...
              >
                ...
                <li className="ourCDRServicesParagraph">
                  ...
                  ></i>
                  Chart of an organisational structure illustrating your
                  position in the project's hierarchy during that Career Episode
                </li>
                <li className="ourCDRServicesParagraph">
                  {" "}
                  <i
            ...
            <Col xs={12} className="mt-md-5">
              ...
              >
                ...
                <li className="ourCDRServicesParagraph">
                  ...
                  ></i>{" "}
                  Information on whether or not the project&apos;s
                  goals/objectives were reached.
                </li>
                <li className="ourCDRServicesParagraph">
                  {" "}
                  <i
                ...
                <li className="ourCDRServicesParagraph">
                  ...
                  ></i>
                  In the conclusion section, explain how your contribution to
                  the project aided the effort.
                </li>
              </ul>
            </Col>
          </Row>
