...
const CDRskillassessmentoptions = ({ data }) => {
  const list = [
    `Each Career Episode report writing must be written in Australian English in your own words. However, knowing English, 
...
o	Career episode report 3 (paragraphs 3.1, 3.2, 3.3, and so on.)
  ...
  return (
    <div style={{ backgroundColor: "#E5E5E5" }} className="pt-3">
      <Container>
        {/* <Headings
          title="CDRskillassessment provides Career Episode Writing Service, taking into 
account the following options:"
        /> */}
        <Headings title={content6[4]?.title} />
        <Paragraphs data={content6[4] && parse(content6[4].paragraph)} />
          ...
          <Row key={i}>
            <Col xs={1} className="pt-4">
              <img
                ...
                src="/images/CareerEpisodeWriting/hat.png"
                alt="hat"
              />
            </Col>
            <Col xs={11}>
